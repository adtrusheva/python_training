...
class TestAddContact(unittest.TestCase):
    ...
    def test_add_contact(self):
        ...
        wd.find_element_by_name("lastname").send_keys("Petrenko")
        ...
        wd.find_element_by_name("company").send_keys("CompDer")
        ...
        wd.find_element_by_name("mobile").send_keys("90274636222")
        wd.find_element_by_name("work").click()
        wd.find_element_by_name("work").clear()
        wd.find_element_by_name("work").send_keys("916382643299")
        ...
        wd.find_element_by_name("email2").send_keys("twoemail@mail.ru")
        wd.find_element_by_name("email3").click()
        wd.find_element_by_name("email3").clear()
        wd.find_element_by_name("email3").send_keys("thirdemail.ry")
        wd.find_element_by_name("homepage").click()
        wd.find_element_by_name("homepage").clear()
        wd.find_element_by_name("homepage").send_keys("tqujslwifh.com")
        ...
        wd.find_element_by_css_selector("select[name=\"aday\"] > option[value=\"11\"]").click()
